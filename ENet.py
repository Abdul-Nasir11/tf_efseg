# Code taken from the Repo:https://github.com/gevero/enet_tensorflow
# The repo also has colab notebook for 3 different appproaches to training the model as described in original paper: https://colab.research.google.com/github/gevero/enet_tensorflow/blob/master/notebooks/Enet%20CamVid%20Training.ipynb#scrollTo=Nj6CWBs86puQ
...
class ENet(tf.keras.Model):
    ...
    '''
    def __init__(self, C=3, l2=0.0, MultiObjective=False, **kwargs):
